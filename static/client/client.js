...
var models = _BindingLayer.models;

function _onModelLoad() {
    models.dnd.bind(document.querySelector('#input_red_x'), 'value', 'red_x', 'change', true, null, parseInt, false);
    models.dnd.bind(document.querySelector('#input_red_y'), 'value', 'red_y', 'change', true, null, parseInt, false);
    models.dnd.bind(document.querySelector('#input_blue_x'), 'value', 'blue_x', 'change', true, null, parseInt, false);
    models.dnd.bind(document.querySelector('#input_blue_y'), 'value', 'blue_y', 'change', true, null, parseInt, false);
